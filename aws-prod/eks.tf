...
module "eks" {
  ...
  workers_additional_policies  = [aws_iam_policy.aws-load-balancer.arn]
}

# Amazon Load Balancer IAM Policy
# see https://github.com/aws/eks-charts/tree/master/stable/aws-load-balancer-controller
resource "aws_iam_policy" "aws-load-balancer" {
  name        = "eks-loadbalancer-policy"
  description = "A policy to allow AWS EKS Workers to access ALB"
